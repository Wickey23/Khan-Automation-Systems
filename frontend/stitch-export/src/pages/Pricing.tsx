      ...
      <nav className="fixed top-0 w-full z-50 bg-slate-50/80 backdrop-blur-xl border-b border-slate-200/50">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link className="text-blue-600 border-b-2 border-blue-600 pb-1 text-sm font-medium" to="/pricing">Pricing</Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
            {tiers.map((tier) => (
              ...
              >
                ...
                <button 
                  onClick={() => navigate(tier.name === 'Enterprise' ? '/contact' : '/dashboard')}
                  className={tier.popular 
