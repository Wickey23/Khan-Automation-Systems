...
export default function AppCallsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
        {callSummaryStrip.map((metric) => (
          <div key={metric.label} className="rounded-xl border border-slate-200 bg-white px-3 py-2.5">
            <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">{metric.label}</p>
      ...
      <div className="flex min-h-[calc(100vh-19rem)] overflow-hidden bg-white">
                ...
                <div className="flex max-w-full items-center gap-1 overflow-x-auto rounded-lg bg-slate-100 p-1">
                  {stateFilters.map((filter) => (
                    <button
                      ...
                      className={cn(
                        "whitespace-nowrap rounded-md px-3 py-1 text-xs font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300",
              ...
              <div className="ml-auto flex items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-8 w-44 rounded-xl border border-slate-200 bg-white pl-8 pr-3 text-xs outline-none focus:border-primary focus-visible:ring-2 focus-visible:ring-sky-300 sm:w-52"
                  />
                </div>
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              <span className={cn("inline-flex rounded-full px-2 py-0.5 text-[10px] font-semibold tracking-[0.02em]", dispositionTone(call))}>
                ...
                <div className="flex h-14 shrink-0 items-center justify-between border-b border-slate-200 bg-white px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-semibold tracking-[0.02em] text-slate-500">
                        {dispositionLabel(selectedCall)} - {formatTime(selectedCall.startedAt)}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className={cn("inline-flex rounded-full px-2.5 py-1 text-[10px] font-semibold tracking-[0.02em]", dispositionTone(selectedCall))}>
                      {dispositionLabel(selectedCall)}
                    </span>
                    <span className="inline-flex rounded-full border border-slate-200 bg-slate-100 px-2.5 py-1 text-[10px] font-semibold tracking-[0.02em] text-slate-700">
                  ...
                  <div className="space-y-3.5">
                    <section className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                          <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">Next call action</p>
                      ...
                      <div className="mt-3 grid gap-2 sm:grid-cols-3">
                        <div className="rounded-md border border-slate-200 bg-white px-3 py-2">
                          <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">What happened</p>
                          <p className="mt-1 text-xs font-semibold text-slate-900">{selectedOutcomeText}</p>
                        </div>
                        <div className="rounded-md border border-slate-200 bg-white px-3 py-2">
                          <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">What matters</p>
                          <p className="mt-1 text-xs font-semibold text-slate-900">{selectedWhatMattersText}</p>
                        </div>
                        <div className="rounded-md border border-slate-200 bg-white px-3 py-2">
                          <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">Do next</p>
                    ...
                    <section className="grid gap-3 sm:grid-cols-3">
                      <div className="rounded-lg border border-slate-200 bg-white px-3 py-2.5">
                        <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">Disposition</p>
                        <p className="mt-1 text-sm font-semibold text-slate-900">{dispositionLabel(selectedCall)}</p>
                      </div>
                      <div className="rounded-lg border border-slate-200 bg-white px-3 py-2.5">
                        <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">Urgency</p>
                        <p className="mt-1 text-sm font-semibold text-slate-900">{priorityLabel(selectedCall.frontDesk?.frontDeskPriority)}</p>
                      </div>
                      <div className="rounded-lg border border-slate-200 bg-white px-3 py-2.5">
                        <p className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">Follow-up state</p>
                    ...
                    <section className="rounded-lg border border-slate-200 bg-white p-5">
                      <div className="mb-4 flex items-center justify-between">
                        <h4 className="text-[11px] font-semibold tracking-[0.04em] text-slate-500">Call transcript</h4>
