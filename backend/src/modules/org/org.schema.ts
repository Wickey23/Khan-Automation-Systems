...
export const updateBusinessSettingsSchema = z.object({
  ...
  serviceRequestAutomationEnabled: z.boolean().optional(),
  serviceRequestFollowupSmsEnabled: z.boolean().optional(),
  serviceRequestInternalAlertsEnabled: z.boolean().optional(),
